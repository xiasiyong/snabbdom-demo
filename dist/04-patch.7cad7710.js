...
},{}],"src/04-patch.js":[function(require,module,exports) {
"use strict";
...
// 导入模块
var patch = (0, _init.init)([_style.styleModule, _eventlisteners.eventListenersModule, _props.propsModule]);
var app = document.querySelector('#app');
var arr1 = [1, 2, 3, 4, 5]; // 一样的

var arr2 = [1, 2, 3, 4, 5]; // 往前添加一个 unshift

var arr3 = [0, 1, 2, 3, 4, 5]; // 让后添加一个 // push

var arr4 = [1, 2, 3, 4, 5, 6]; // 往前删除一个 shift

var arr5 = [2, 3, 4, 5]; // 往后删除一个 pop

var arr6 = [1, 2, 3, 4]; // 中间插入一个 spilce

var arr7 = [1, 2, 7, 8, 3, 5]; // 中间删除一个 splice

var arr8 = [1, 2, 4, 5]; // 倒序 sort
...
var oldNode = (0, _h.h)('ul', createNodesWithKey(arr1));
patch(app, oldNode); // const newNode = h('ul', createNodes(arr2))
// const newNode = h('ul', createNodes(arr3))
// const newNode = h('ul', createNodes(arr4))

var newNode = (0, _h.h)('ul', createNodesWithKey(arr7));
patch(oldNode, newNode);
},{"snabbdom/build/package/init":"node_modules/snabbdom/build/package/init.js","snabbdom/build/package/h":"node_modules/snabbdom/build/package/h.js","snabbdom/build/package/modules/style":"node_modules/snabbdom/build/package/modules/style.js","snabbdom/build/package/modules/eventlisteners":"node_modules/snabbdom/build/package/modules/eventlisteners.js","snabbdom/build/package/modules/props":"node_modules/snabbdom/build/package/modules/props.js"}],"node_modules/_parcel-bundler@1.12.4@parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/_parcel-bundler@1.12.4@parcel-bundler/src/builtins/hmr-runtime.js","src/04-patch.js"], null)
//# sourceMappingURL=/04-patch.7cad7710.js.map